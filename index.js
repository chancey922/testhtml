...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[1697,201,105,105],[1697,0,201,199],[1256,0,439,203],[1900,0,95,263],[0,0,1254,377],[0,379,1009,130],[1997,0,20,88]]}
];
...
p.nominalBounds = new cjs.Rectangle(-0.5,0,100.5,99.5);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		if (this.circle_1.hitTest(stage.mouseX, stage.mouseY)) { 
			this.circle_1.alpha = 1; 
		}
	}
	...
	// fiber
	this.instance_1 = new lib.circle_2("synched",0);
	this.instance_1.setTransform(681.05,511,1,1,0,0,0,26.3,26.3);

	this.instance_2 = new lib.circle_1("synched",0);
	this.instance_2.setTransform(604.6,442.45,1,1,0,0,0,49.6,49.8);

	this.instance_3 = new lib.CachedBmp_9();
	this.instance_3.setTransform(205.5,306.55,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).to({state:[{t:this.instance_3}]},4).wait(1));

	// neuron
	this.instance_4 = new lib.CachedBmp_11();
	this.instance_4.setTransform(107,37.25,0.5,0.5);
